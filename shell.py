...
def receipt(i_d, dict_log, dict_inventory, number, date):
    ...
    print("\n")
    print("\t╔══════════════════════════════════════════════╗")
    print("\t║     \t",cool_letters.print_cool_letters('Game-Flix'), "      ║")
    print("\t║----------------------------------------------║")
    print("\t║Item:", dict_inventory[number]['name'].ljust(38), "║")
    print("\t║Price per day:", str(dict_inventory[number]['price']).ljust(29), "║")
    print("\t║Days checked out:", str(dict_log[i_d]['days']).ljust(28), "║")
    print("\t║Rent Charge:", str(dict_log[i_d]['rent charge']), "".ljust(27), "║")
    print("\t║Sales Tax: 0.07                               ║")
    print("\t║Total sales:", str(dict_log[i_d]['total']) , ''.ljust(26), "║" )
    print("\t║Time checked out:", str(dict_log[i_d]['time checked out']), "".ljust(14), "║")
    print("\t║Time checked in:", str(dict_log[i_d]['time checked in']), "".ljust(15), "║")
    print("\t║Transaction time:", date, "".ljust(14), "║" )
    print("\t║--------------------------------------------- ║" )
    print("\t║            ",code, "          ║")
    print("\t║            ",code, "          ║")
